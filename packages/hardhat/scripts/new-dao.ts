...
const transform = (params) => ({
  ...
  gardenTokenLiquidity: Math.floor(
    params.gardenTokenLiquidity * ONE_TOKEN
  ).toString(),
  ...
  actionAmountStable: Math.floor(
    params.actionAmountStable * ONE_TOKEN
  ).toString(),
  challengeAmountStable: Math.floor(
    params.challengeAmountStable * ONE_TOKEN
  ).toString(),
